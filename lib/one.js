...
exports.init = function (gulp, options) {
    ...
    one.link(one.transforms.svg.minify).to(one.clonedTransforms.svg.inject.dev, { primary: false });
    ...
    one.link(one.transforms.svg.minify).to(one.clonedTransforms.svg.inject.prod, { primary: false });
