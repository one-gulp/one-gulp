...
//
//var cwd = '/home/hsablonniere/dev/one-gulp/example-projects/simple-html-css-js/src';
//
//var html = gulp.src(['**/*.html', '**/*.md', '**/*.jade'], { cwd: cwd });
//var css = gulp.src(['**/*.css', '**/*.scss', '**/*.less', '**/*.styl'], { cwd: cwd });
//var js = gulp.src(['**/*.js', '**/*.coffee', '**/*.ts'], { cwd: cwd });
//
//var stream = merge([html, css, js]);
//
//
//stream.on('data', function (file) {
