...
exports.init = function (gulp, options) {
    ...
    function pass(stream) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            stream
                ...
                .on('end', function () {
                    resolve(streamify(array));
                });
        });
    }

    gulp.task('preprocess/foo', function () {

        return pass(streams.fromExts(options.src, options.exts.html));
    });

    gulp.task('preprocess/bar', function () {

        return pass(streams.fromExts(options.src, options.exts.css));
    });
    ...
    gulp.task('preprocess/jade', function () {
        ...
        return pass(streams.fromExts(options.src, ['jade'])
    ...
    gulp.task('preprocess/markdown', function () {
        ...
        return pass(streams.fromExts(options.src, ['md'])
